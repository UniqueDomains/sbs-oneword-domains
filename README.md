...
**Public extract:** 9,329 rows · **Live catalog:** 5,621,991 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/sbs?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_sbs_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/sbs?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_sbs_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./sbs.csv">CSV</a> / <a href="./sbs.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_sbs_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_sbs_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .SBS search](https://unique.domains/domains/tld/sbs?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_sbs_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .SBS search](https://unique.domains/domains/tld/sbs?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_sbs_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./sbs.csv) or [Download JSON](./sbs.json)
...
- `sbs.csv` — public CSV extract (9,329 rows)
- `sbs.json` — public JSON extract (9,329 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,329-row public sample | 5,621,991 live domains                           |
...
| seoul.sbs      | available | $1.49     | —             | 74             | 26     | 5      | name.com                           |
| europe.sbs     | resell    | —         | —             | 68             | 39     | 6      | Porkbun, LLC                       |
...
> Unique Domains. *Available .SBS One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
